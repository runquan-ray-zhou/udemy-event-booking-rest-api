...
func RegisterRoutes(server *gin.Engine) {
	...
	authenticated.POST("/events/:id/register", registerForEvent)     // register event by authorized user route
	authenticated.DELETE("/events/:id/register", cancelRegistration) // delete event by authorized user route
